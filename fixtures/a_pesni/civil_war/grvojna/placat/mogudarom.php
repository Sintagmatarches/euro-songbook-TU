...
<html>
<head>
<title>Могучим ударом труда мы уничтожим оковы разрухи (советский плакат, В. Кудряшов, 1921)</title>
<meta name="Description" content="Плакат Виктора Кудряшова с призывом ликвидировать разруху, вызванную Гражданской войной">
<meta name="Keywords" content="Виктор Кудряшов, плакат, разруха">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br>
        <span class="text"> <img src="mogudarom.jpg" alt="Могучим ударом труда мы уничтожим оковы разрухи (В. Кудряшов, 1921)" width="400" height="614"><br>
  <br>
  <span class="header"><strong>МОГУЧИМ УДАРОМ ТРУДА МЫ УНИЧТОЖИМ ОКОВЫ РАЗРУХИ<br>
  </strong><br>
        </span> Советский плакат, Владимир Кудряшов, 1921<br>
  <br>
<br>
