...
<html>
<head>
<title>Последний час (советский плакат, В. Дени, 1920)</title>
<meta name="Description" content="Плакат Виктора Дени против независимой Польши и Врангеля">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br>
        <span class="text"> <img src="posl.jpg" alt="Последний час (В. Дени, 1920)" width="400" height="546"><br>
  <br>
        <span class="header"><strong>ПОСЛЕДНИЙ ЧАС<br>
  </strong><br>
