...
<input name='hl' value='ru' type='hidden'/></form><br><hr></head><body><h1 hidden>Песни Народного фронта Чили - Canciones del Frente Popular de Chile</h1>
<br>
          <span class='top'>НАРОДНЫЙ ФРОНТ ЧИЛИ<br>
          EL FRENTE POPULAR DE CHILE<br>
		  1936-1973</span><br>
			 <br> 
	 <a href="elpueblo.php">El 
    pueblo unido</a><br>
        <a href="enelstadio.php">En el Stadio de Chile</a><br>
        <a href="venceremos.php">Venceremos</a><br>
