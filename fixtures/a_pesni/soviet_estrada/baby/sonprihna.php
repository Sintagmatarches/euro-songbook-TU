...
<html>
<head>
<title>И. Дунаевский, В. Лебедев-Кумач - Сон приходит на порог (из кинофильма &quot;Цирк&quot;)</title>
<meta name="Description" content="Текст колыбельной человечку, которому открыты сто дорог">
<meta name="Keywords" content="фильм Цирк, Исаак Дунаевский, Василий Лебедев-Кумач"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<br><span class="text">
	<span class="header"><strong>СОН 
ПРИХОДИТ НА ПОРОГ</strong><br></span>
Из кинофильма «Цирк» (1936)<br>
<br>
        Музыка Исаака Дунаевского<br>
        Слова Василия Лебедева-Кумача<br>
<br>
Сон приходит на порог,<br>
  Крепко-крепко спи ты!<br>
  Сто путей,<br>
  Сто дорог<br>
  Для тебя открыты.<br>
  Все на свете отдыхает:<br>
  Ветер затихает,<br>
  Небо спит,<br>
  Солнце спит,<br>
  И луна зевает.<br>
<br>
Спи, сокровище мое,<br>
  Ты такой богатый –<br>
  Все твое,<br>
  Все твое:<br>
  Звезды и закаты.<br>
  Завтра солнышко проснется,<br>
  Снова к нам вернется.<br>
  Молодой,<br>
  Золотой,<br>
  Новый день начнется.<br>
<br>
Чтобы завтра рано встать<br>
  Солнышку навстречу,<br>
  Надо спать,<br>
  Крепко спать,<br>
  Милый человечек!<br>
  Спят зайчонок и мартышка,<br>
