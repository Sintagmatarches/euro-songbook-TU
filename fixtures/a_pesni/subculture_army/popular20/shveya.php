...
<html>
<head>
<title>Я. Морозов и Мощеревский -Швея (В комнатке убогой...)</title>
<meta name="Description" content="Тпекст жестокого романса о смерти бедной швеи">
<meta name="Keywords" content="швея, Морозов, Мощеревский"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="justify">
	  <br><a href="Popular20.php"><img src="popular20.png" width="118" height="57" border="0"></a><br>
	    <br>
	    <span class="text">
	      <span class="header"><strong>ШВЕЯ</strong></span><br>
	 
	    <br>
       В комнатке убогой<br>
        Черный гроб стоит,<br>
        В нем швея-сиротка<br>
        Бедная лежит.<br>
	  <br>Будет... Потрудились.<br>
	    Рученьки твои;<br>
	    Как ведь истомились<br>
	    От забот они!<br>
	  <br>Чуть бывало зорька<br>
	    Только расцветет,<br>
	    У тебя тревога<br>
	    В комнате идет.<br>
	  <br>Так всю жизнь трудилась,<br>
	    Билась ты с нуждой;<br>
	    Счастье не встречалось<br>
	    С бедной сиротой<br>
	  <br>Сила молодая<br>
	    Сгибла от труда<br>
	    ты ушла от жизни<br>
	    В вечность навсегда!<br>
	  <br>Будет... Потрудились<br>
	    Рученьки твои...<br>
	    Как ведь истомились<br>
	    От забот они...<br>
	    <em><br>
	    На сопках Манчжурии. Новый песенник. М.: Типография П.В. Бельцова, 1914. С. 10. Подпись: Я. Морозов, Мощеревский.</em><br>
	  <br>
	    <br>
	    </span><br>
	</div></td>
