...
<html>
<head>
<title>М. Блантер, К. Симонов - Шли со службы три солдата</title>
<meta name="Description" content="Текст песенки Великой Отечественной войны о возвращении и свадьбе солдат">
<meta name="Keywords" content="Матвей Блантер, Константин Симонов, солдаты"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<br>
	<span class="header"><strong>ШЛИ 
СО СЛУЖБЫ ТРИ СОЛДАТА</strong><br></span> 
<br>
Музыка Матвея Блантера<br>
Слова Константина Симонова<br>
<br>
Шли со службы три солдата,<br>
Увидали - стоит хата,<br>
В хате три окошка,<br>
В каждом по девице,<br>
Они смотрят из окошек,<br>
Ласково глядя.<br>
<br>
Поженились три солдата<br>
И построил каждый хату.<br>
Родили по сыну,<br>
Холили, растили<br>
И, как вышел срок, послали<br>
В армию служить.<br>
<br>
Детки храбро воевали,<br>
Всюду, всюду побывали.<br>
Только срок выходит<br>
Службу оставлять им,<br>
Они вещи собирают<br>
И домой идут.<br>
<br>
Шли со службы три солдата,<br>
Увидали - стоит хата,<br>
