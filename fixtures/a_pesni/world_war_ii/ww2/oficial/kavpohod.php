...
<html>
<head>
<title>А. Гайдар - Кавалерийскяа походная</title>
<meta name="Description" content="Стихотворение-песня Аркадия Гайдара о готовности к новой войне на Западной границе">
<meta name="Keywords" content="Аркадий Гайдар">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
    ...
    <td width="776" valign="top" bgcolor="#FFFFFF">	<div align="justify"><a href="Oficial.php"><img src="oficial-ww2.png" width="183" height="86" border="0" ></a><br>
	<br>
	<span class="text">
	<span class="header"><strong>КАВАЛЕРИЙСКАЯ ПОХОДНАЯ</strong></span>
  <br>
  <br>
  Аркадий Гайдар<br>
  <br>
Травы наземь клонятся,<br>
	  Ветер тучи рвет,<br>
	  А по степи конница<br>
	  Красная идет.<br>
	  <div style="margin-left:32px">Пылью придорожною<br>
	  Затуманен взор,<br>
	  С вестью к нам тревожною<br>
	  Прискакал дозор.</div>
	  — Эй вы, кони-птицы!<br>
	  Ну-ка, с шага в рысь…<br>
	  К западным границам<br>
	  Тучи собрались.<br>
	 <div style="margin-left:32px"> Странный шум нам слышен<br>
	  С вражьей стороны,<br>
	  Что-то ветер дышит<br>
	  Запахом войны. —</div>
	  Отвечал ребятам<br>
	  Командир седой:<br>
	  — Красные солдаты<br>
	  Все готовы в бой.<br>
	  <div style="margin-left:32px">Скатки приторочены,<br>
	  Пики на весу,<br>
	  Сабли поотточены,<br>
	  Кони — понесут.</div>
	  Смелости немало<br>
	  Позапасено,<br>
	  Красного сигнала<br>
	  Ждем мы день и ночь. —<br>
	  <div style="margin-left:32px">Травы наземь клонятся,<br>
	  Сталь звенит о сталь,<br>
	  Это рысью конница<br>
	  Унеслася вдаль…</div>
  <br>
  <em>1927</em><br>
<br>
  <em>Гайдар А. Собр. соч. в 4 т. Т. 3. М.: Дет. лит., 1964. С. 377-379.</em><br><br><br>
  Стихотворение Аркадия Гайдара, написанное, судя по заглавию, как песня.<br>
  <br><br>
  <br>
