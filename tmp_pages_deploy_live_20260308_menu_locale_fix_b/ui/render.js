...
function draftResolveLinePopoverMetrics(editorRect, textRect, anchorRect, popoverNode) {
  ...
  const availableWidth = Math.max(180, viewportWidth - horizontalInset);
  const maxPopoverWidth = Math.max(180, Math.min(availableWidth, 560));
  const desiredWidth = isCompactMobile ? Math.round(editorRect.width - 4) : Math.round(textRect.width);
  const popoverWidth = Math.max(180, Math.min(desiredWidth, maxPopoverWidth));
  const baseLeft = isCompactMobile ? 0 : Math.max(0, Math.round(textRect.left - editorRect.left));
...
function requestDraftBannerText() {
  const canPublishDirectly = can("songs.edit");
  if (uiLocale() === "ru") {
    return canPublishDirectly
      ? "\u0412\u0430\u0448\u0438 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u044b \u043b\u043e\u043a\u0430\u043b\u044c\u043d\u043e. \u041e\u043f\u0443\u0431\u043b\u0438\u043a\u0443\u0439\u0442\u0435 \u0438\u0445, \u043a\u043e\u0433\u0434\u0430 \u0431\u0443\u0434\u0435\u0442\u0435 \u0433\u043e\u0442\u043e\u0432\u044b."
      : "\u0412\u0430\u0448\u0438 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u044b \u043b\u043e\u043a\u0430\u043b\u044c\u043d\u043e. \u041e\u0442\u043f\u0440\u0430\u0432\u044c\u0442\u0435 \u0437\u0430\u044f\u0432\u043a\u0443, \u043a\u043e\u0433\u0434\u0430 \u0431\u0443\u0434\u0435\u0442\u0435 \u0433\u043e\u0442\u043e\u0432\u044b.";
  }
  if (uiLocale() === "uk") {
    return canPublishDirectly
      ? "\u0412\u0430\u0448\u0456 \u0437\u043c\u0456\u043d\u0438 \u0437\u0431\u0435\u0440\u0435\u0436\u0435\u043d\u043e \u043b\u043e\u043a\u0430\u043b\u044c\u043d\u043e. \u041e\u043f\u0443\u0431\u043b\u0456\u043a\u0443\u0439\u0442\u0435 \u0457\u0445, \u043a\u043e\u043b\u0438 \u0431\u0443\u0434\u0435\u0442\u0435 \u0433\u043e\u0442\u043e\u0432\u0456."
      : "\u0412\u0430\u0448\u0456 \u0437\u043c\u0456\u043d\u0438 \u0437\u0431\u0435\u0440\u0435\u0436\u0435\u043d\u043e \u043b\u043e\u043a\u0430\u043b\u044c\u043d\u043e. \u041d\u0430\u0434\u0456\u0448\u043b\u0456\u0442\u044c \u0437\u0430\u044f\u0432\u043a\u0443, \u043a\u043e\u043b\u0438 \u0431\u0443\u0434\u0435\u0442\u0435 \u0433\u043e\u0442\u043e\u0432\u0456.";
  }
  if (uiLocale() === "et") {
    return canPublishDirectly
      ? "Sinu muudatused on lokaalselt salvestatud. Avalda need siis, kui oled valmis."
      : "Sinu muudatused on lokaalselt salvestatud. Saada taotlus siis, kui oled valmis.";
  }
  return canPublishDirectly
    ? "Your changes are saved locally. Publish them when you are ready."
    : "Your changes are saved locally. Submit the request when you are ready.";
}
