...
function homeMultiVersionsSongsLabel() {
  if (uiLocale() === "ru") return "Песни с несколькими вариантами";
  if (uiLocale() === "uk") return "Пісні з кількома варіантами";
  if (uiLocale() === "et") return "Mitme variandiga laulud";
  return "Songs with multiple variants";
...
function homeUI(data, params, homeExtras = {}) {
  ...
  const multiVersionsEntryHref = catalogHashForSongFilter({
    q: "",
    lang: "",
    country: "",
    period: "",
    ...
    <section class="yt-main home-main">
      <div class="yt-detail-trigger" id="yt_detailToggleWrap">
        <div class="yt-detail-trigger-actions">
          ...
          <a class="btn ghost ${multiVersions ? "is-active" : ""}" id="yt_openMultiVersions" href="${esc(multiVersionsEntryHref)}">${esc(homeMultiVersionsSongsLabel())}</a>
        </div>
      </div>
