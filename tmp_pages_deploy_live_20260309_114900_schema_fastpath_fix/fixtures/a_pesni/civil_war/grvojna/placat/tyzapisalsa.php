...
<html>
<head>
<title>Ты записался добровольцем? (советский плакат, Д. Моор, 1920)</title>
<meta name="Description" content="Плакат Дмитрия Моора с призывом вступать в Красную Армию">
<meta name="Keywords" content="Дмитрий Моор, плакат">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br>
        <span class="text"> <a href="tyzapisalsa.jpg" target="_blank"><img src="tyzapisalsa.jpg" alt="Ты записался добровольцем? (Д. Моор, 1920)" width="412" height="595" border="0"></a><br>
  <br>
  <span class="header"><strong>ТЫ ЗАПИСАЛСЯ ДОБРОВОЛЬЦЕМ?</strong><br></span>
  <br>
        Советский плакат, Дмитрий Моор, 1920<br>
  <br>
        <em>С сайта <a href="http://pretich2005.narod.ru/illustrations/plakat/moor-dobrovol.htm" target="_blank">&quot;Претич&quot;</a></em><br>
<br>
	<br>
