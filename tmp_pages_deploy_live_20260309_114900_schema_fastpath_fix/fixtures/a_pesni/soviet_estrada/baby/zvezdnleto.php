...
<html>
<head>
<title>А. Пугачева, И. Резник - Звездное лето</title>
<meta name="Description" content="Текст песни Аллы Пугачевой и Ильи Резника о желании, чтобы лето не кончалось">
<meta name="Keywords" content="Алла Пугачева, Илья Резник"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="justify"> <a href="Baby.php"><img src="baby.png" width="98" height="97" border="0"></a> 
        <img src="../drugije/drugije.png" width="140" height="83"><br>
	<br><span class="text">
	<span class="header"><strong>ЗВЕЗДНОЕ 
ЛЕТО </strong> <br></span>
<br>
        Музыка Аллы Пугачевой<br>
        Слова Ильи Резника<br>
<br>
Вся земля<br>
  Теплом согрета,<br>
  ...
  Я пою,<br>
  И звезды лета<br>
  Светят мне даже днем, даже днем.<br>
<br>
        <em>Припев:</em><br>
<br>
Я так хочу,<br>
  ...
  Удивительные звезды<br>
  Дарили свет.<br>
  Лето! Ах, лето!<br>
  Лето звездное звонче пой!<br>
  Лето! Ах, лето!<br>
  Лето звездное, будь со мной!<br>
<br>
Дождь грибной<br>
  Играет в прятки<br>
