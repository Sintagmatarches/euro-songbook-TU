...
<html>
<head>
<title>С. Копыткин - В полевом лазарете</title>
<meta name="Description" content="Стихотворение Первой мировой войны о предсмертном письме солдата">
<meta name="Keywords" content="Копыткин, лазарет, Львов"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<br>
	<span class="text">
	<span class="header"><strong>В ПОЛЕВОМ ЛАЗАРЕТЕ </strong></span><br>
	<br>
	С. Копыткин<br>
<br>Ночь прорвет наболевшие нити...<br>
	  Вряд ли их дотянуть до утра...<br>
	  Я прошу об одном, напишите,<br>
	  Напишите три строчки, сестра.<br>
	<br>Вот вам адрес жены моей бедной,<br>
	  Напишите ей несколько слов,<br>
	  Что я в руку контужен безвредно,<br>
	  Поправляюсь и буду здоров.<br>
	<br>Напишите, что мальчика Вову<br>
	  Я целую, как только могу,<br>
	  И австрийскую каску из Львова<br>
	  Я в подарок ему берегу.<br>
	<br>А отцу напишите отдельно,<br>
	  Как прославлен наш доблестный полк,<br>
	  И что в грудь я был ранен смертельно,<br>
	  Исполняя свой воинский долг.<br>
	  <br>
	  <em>В.И. Симаков. Прапорщик. Новейший военный песенник. 2-е испр. и дополн. издание. Пг.: Издание книжной торговли Н.И. Холмушина, 1916. [Разрешено военной цензурой за №4643, 7 мая 1916 г.]. С. 81.</em><br>
	  <br><br>
	  В песеннике Симакова размещено в разделе &quot;Военные стихи&quot;.<br>
	  <br>
	  <br>
