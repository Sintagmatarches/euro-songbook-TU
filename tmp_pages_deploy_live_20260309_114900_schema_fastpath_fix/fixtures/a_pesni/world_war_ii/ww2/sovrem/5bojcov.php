...
<html>
<head>
<title>В. Бохан, Э. Асадов - Пять бойцов</title>
<meta name="Description" content="Текст песни опяти бойцах, мечтающих в землянке о девчатах">
<meta name="Keywords" content="Владимир Бохан"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<br>
	<span class="header"><strong>ПЯТЬ 
БОЙЦОВ </strong><br></span> 
<br>
Музыка Владимира Бохана<br>
Слова Эдуарда Асадова<br>
<br>
Огонек чадит в землянке, <br>
Дым махорочный столбом... <br>
Пять бойцов сидят в землянке <br>
И мечтают кто о чем. <br>
<br>
В тишине да на покое <br>
Помечтать оно не грех. <br>
Вот один боец с тоскою, <br>
Глаз сощуря, молвил: "Эх!" <br>
<br>
И замолк. Второй качнулся. <br>
Подавил протяжный вдох, <br>
Вкусно дымом затянулся <br>
И с улыбкой молвил: "Ох!" <br>
<br>
"Да!" - ответил третий, взявшись <br>
За починку сапога, <br>
А четвертый, размечтавшись, <br>
Пробасил в ответ: "Ага!" <br>
<br>
"Не могу уснуть, нет мочи! -<br>
Пятый вымолвил солдат. -<br>
Ну чего вы, братцы, к ночи<br>
Разболтались про девчат!"<br>
<br>
