      ...
      <section class="songbook-import-layout">
        ...
        <div class="card songbook-import-main" id="songbookImportRoot">
          <div class="row wrap gap songbook-import-head">
            ...
            <div class="actions">
              <button class="btn ghost" id="sb_new_session" type="button">${esc(songbookImportUiText("newSession"))}</button>
            </div>
          </div>
          <div class="sep"></div>
          ...
          <label class="field">
            ...
            <input class="input" id="sb_source_name" value="${esc(selected?.source_name || "")}" placeholder="${esc(songbookImportUiText("sourceName"))}" />
          </label>
          <div class="grid2 songbook-import-top-grid">
            <label class="field">
              <div class="fieldLabel">${esc(songbookImportUiText("importLang"))}</div>
              <input class="input" id="sb_import_lang" value="${esc(selectedImportLang)}" placeholder="bel+rus" />
            </label>
            <label class="field">
              <div class="fieldLabel">${esc(songbookImportUiText("importCountry"))}</div>
              <input class="input" id="sb_import_country" value="${esc(selected?.import_country || "")}" />
            </label>
          </div>
          <label class="field">
            <div class="fieldLabel">${esc(songbookImportUiText("extractMode"))}</div>
            <select class="select" id="sb_extraction_mode">
          ...
          <label class="field">
            ...
            <input class="input" id="sb_file" type="file" accept=".pdf,.png,.jpg,.jpeg,.webp,.txt,.md,.rtf" />
          </label>
          <div class="actions songbook-import-actions">
            <button class="btn" id="sb_extract" type="button">${esc(songbookImportUiText("upload"))}</button>
            <button class="btn ghost" id="sb_insert_marker" type="button">${esc(songbookImportUiText("insertMarker"))}</button>
            <button class="btn" id="sb_save" type="button">${esc(songbookImportUiText("save"))}</button>
            <button class="btn primary" id="sb_submit" type="button"${selected?.status === "submitted" ? " disabled" : ""}>${esc(songbookImportUiText("submit"))}</button>
          </div>
          ...
          <div class="muted small">${esc(songbookImportUiText("markerHint"))}</div>
          <div class="sep"></div>
          <label class="field">
            <div class="fieldLabel">${esc(songbookImportUiText("editor"))}</div>
            <textarea class="textarea song-editor-text song-editor-text-main songbook-import-editor" id="sb_editor_text" wrap="off">${esc(selected?.editor_text || "")}</textarea>
          </label>
          <details class="songbook-import-raw-wrap">
            <summary>${esc(songbookImportUiText("raw"))}</summary>
            <textarea class="textarea song-editor-text songbook-import-raw" id="sb_raw_text" wrap="off">${esc(selected?.raw_text || "")}</textarea>
          </details>
          <div class="sep"></div>
...
export function bind(route, ctx) {
  ...
  if (route.name === "admin" && ctx.section === "imports") {
    ...
    const newSessionBtn = qs("sb_new_session");
    ...
    const setBusy = (busy, message = "") => {
      [extractBtn, saveBtn, submitBtn, insertMarkerBtn, newSessionBtn].forEach((node) => {
