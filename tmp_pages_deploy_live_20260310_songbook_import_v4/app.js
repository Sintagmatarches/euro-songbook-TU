...
function adminImportNavText() {
  if (state.locale === "ru") return "Импорт";
  if (state.locale === "uk") return "Імпорт";
  if (state.locale === "et") return "Import";
  return "Import";
}
...
function applyStaticTexts() {
  ...
  setNavLabel("dNavAdminImports", adminImportNavText());
...
function setActiveNav() {
  ...
  document.getElementById("dNavAdminImports")?.classList.toggle("hidden", !canEditSongs);
