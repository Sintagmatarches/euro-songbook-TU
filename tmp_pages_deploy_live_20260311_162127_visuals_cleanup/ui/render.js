          ...
          <div class="ab-flag-preview-grid">
            <div class="ab-flag-preview-wrap">
              ...
              <div class="yt-card ab-flag-preview ab-flag-preview-long-desktop" id="ab_flag_preview_long_desktop" data-empty="${esc(flagNoImage)}">
                <div class="yt-card-content">
                  <div class="yt-card-title">${esc(flagPreviewSong)}</div>
                  <div class="yt-card-meta-row"><span class="yt-card-line" id="ab_flag_preview_country_desktop">${esc(flagPreviewCountry)}</span></div>
                </div>
              </div>
            </div>
            <div class="ab-flag-preview-wrap">
              ...
              <div class="yt-card ab-flag-preview ab-flag-preview-long-mobile" id="ab_flag_preview_long_mobile" data-empty="${esc(flagNoImage)}">
                <div class="yt-card-content">
                  <div class="yt-card-title">${esc(flagPreviewSong)}</div>
                  <div class="yt-card-meta-row"><span class="yt-card-line" id="ab_flag_preview_country_mobile">${esc(flagPreviewCountry)}</span></div>
                </div>
              </div>
            </div>
          </div>
...
function bindAdminHistoricalVisuals(ctx) {
  ...
  const flagRefs = {
    ...
    previewCountryDesktop: qs("ab_flag_preview_country_desktop"),
    previewCountryMobile: qs("ab_flag_preview_country_mobile"),
  };
  const scopeRefs = {
  ...
  function updatePreviewCountryLabels() {
    const label = currentCountry() ? formatCountry(currentCountry()) : "";
    if (flagRefs.previewCountryDesktop) flagRefs.previewCountryDesktop.textContent = label;
    if (flagRefs.previewCountryMobile) flagRefs.previewCountryMobile.textContent = label;
  }

  function applyFlagPreviewNode(node, url) {
    if (!node) return;
    const hasFlag = !!url;
  ...
  function applyFlagPreview() {
    const longDesktopUrl = String(flagRefs.urlDesktop?.value || "").trim();
    const longMobileUrl = String(flagRefs.urlMobile?.value || "").trim() || longDesktopUrl;
