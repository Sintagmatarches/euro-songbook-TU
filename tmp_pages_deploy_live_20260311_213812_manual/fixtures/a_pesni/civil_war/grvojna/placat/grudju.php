...
<html>
<head>
<title>Грудью на защиту Петрограда (советский плакат, А. Апсит, 1919)</title>
<meta name="Description" content="Советский плакат с призывом защитить Петрограда от Юденича">
<meta name="Keywords" content="Александр Апсит, Петроград, плакат">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br><span class="text"><img src="grudju.jpg" alt="Грудью на защиту Петрограда (А. Апсит, 1919)" width="550" height="369"> 
  <br>
  <br>
  <span class="header"><strong>ГРУДЬЮ НА ЗАЩИТУ ПЕТРОГРАДА!</strong><br></span>
  <br>
        Советский плакат, Александр Апсит, 1919<br>
  <br>
<br>
