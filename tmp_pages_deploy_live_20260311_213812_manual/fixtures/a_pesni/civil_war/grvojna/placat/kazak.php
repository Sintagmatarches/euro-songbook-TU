...
<html>
<head>
<title>Казак, ты с кем? С нами или с ними? (советский плакат, Д. Моор, 1920)</title>
<meta name="Description" content="Плакат Дмитрия Моора, агитирующий казаков воевать за красных">
<meta name="Keywords" content="Дмитрий Моор, плакат, казак">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br>
        <span class="text"><img src="kazak.jpg" alt="Казак, ты с кем? С нами или с ними? (Д. Моор, 1920)" width="567" height="746"> 
        <br>
        <br>
        <span class="header"><strong>КАЗАК, ТЫ С КЕМ?<br>
        С НАМИ ИЛИ С НИМИ?</strong><br>
        </span> <br>
        Советский плакат, Дмитрий Моор, 1920<br>
        <br>
        <em>С сайта <a href="http://pretich2005.narod.ru/illustrations/plakat/kazak-skem.htm" target="_blank">&quot;Претич&quot;</a></em><br>
		<br>
		<br>
        </span></div></td>
    <td width="72" valign="top" bgcolor="#FFFFFF"> 
