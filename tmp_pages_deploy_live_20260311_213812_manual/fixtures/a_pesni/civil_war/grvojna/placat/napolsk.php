...
<html>
<head>
<title>На польский фронт (окно РОСТА, И. Малютин, 1920)</title>
<meta name="Description" content="Плакат Ивана Малютина в поддержку польской кампании Красной Армии 1920 года">
<meta name="Keywords" content="Иван Малютин, Окна РОСТА">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br><span class="text"><img src="napolsk.jpg" alt="На польский фронт (И. Малютин, 1920)" width="400" height="530"><br>
  <br>
        <span class="header"><strong>НА ПОЛЬСКИЙ ФРОНТ.<br>
  КРЕПНЕТ КОММУНА ПОД ПУЛЬ РОЕМ.<br>
  ТОВАРИЩИ, ПОД ВИНТОВКОЙ СИЛЫ УТРОИМ!</strong><br></span>
  <br>
        Окно РОСТА, Иван Малютин, 1920<br>
<br>  
<br>
