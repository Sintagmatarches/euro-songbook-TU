...
<html>
<head>
<title>На Врангеля Антанта полна злобы... (Окно РОСТА №580, М. Черемных, 1920)</title>
<meta name="Description" content="Плакат Михаила Черемных против Антанты, из Окон РОСТА">
<meta name="Keywords" content="Михаил Черемных, Окна РОСТА">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br>
        <span class="text"><img src="navrangela.jpg" alt="На Врангеля Антанта полна злобы... (Окно РОСТА №580, М. Черемных, 1920)" width="400" height="982"><br>
        <br>
        <span class="header"><strong>НА ВРАНГЕЛЯ АНТАНТА ПОЛНА ЗЛОБЫ...<br>
        </strong>
        </span> <br>
        Окно РОСТА №580, Михаил Черемных, 1920<br>
        <br>
        <br>
        </span></div></td>
    <td width="72" valign="top" bgcolor="#FFFFFF"> 
