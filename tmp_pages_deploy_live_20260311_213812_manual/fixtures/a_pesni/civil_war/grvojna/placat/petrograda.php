...
<html>
<head>
<title>Петрограда не отдадим! (советский плакат, Д. Моор, 1919)</title>
<meta name="Description" content="Плакат Дмитрия Моора с призывом защитить Петроград от Юденича">
<meta name="Keywords" content="Дмитрий Моор, Петроград, плакат">
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="center"> <a href="Placat.php"><img src="plakat.png" width="169" height="70" border="0"></a> 
        <br>
	<br><span class="text"><img src="petrograda.jpg" alt="Петрограда не отдадим! (Д. Моор, 1919)" width="400" height="631"> 
  <br>
  <br>
  <span class="header"><strong>ПЕТРОГРАДА НЕ ОТДАДИМ!</strong><br></span>
  <br>
        Советский плакат, Дмитрий Моор, 1919<br>
        <br>
<br>
