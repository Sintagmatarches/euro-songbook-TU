...
<html>
<head>
<title>И. Шварц, Б. Окуджава - Затихнет шрапнель</title>
<meta name="Description" content="Текст песни о возвращении к мирной жизни">
<meta name="Keywords" content="шрапнель, шинель, трубач, Булат Окуджава"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<div align="justify"><span class="text"> <a href="../../bard/okudzava/Okudzava.php"><img src="../../bard/okudzava/okudzava.png" width="138" height="50" border="0"></a> <a href="../../grvojna/sovremen/Sovrem.php"><img src="../../grvojna/sovremen/sovrem.png" width="193" height="57" border="0"></a><br>
	<br>
	<span class="header"><strong>ЗАТИХНЕТ 
ШРАПНЕЛЬ</strong><br></span> 
Из кинофильма &quot;Дела давно минувших дней&quot; <br>
<br>
Музыка Исаака Шварца<br>
  Слова Булата Окуджава<br>
<br>
Затихнет шрапнель <br>
  И начнется апрель<br>
  На прежний пиджак<br>
  Поменяю шинель.<br>
  Вернутся, <br>
  Вернутся полки из похода<br>
  Такая<br>
  Такая сегодня погода<br>
<br>
В назначенный час 
  <br>
  Заиграет трубач<br>
  Что есть нам удача <br>
  Средь всех неудач<br>
  Что мы <br>
  Что мы все еще молодые<br>
  И крылья<br>
  И крылья у нас золотые!<br>
<br>

<a href="http://www.songkino.ru" target="_blank"><em>Songkino.ru</em></a><br>
  <br>
<br>
&quot;Дела давно минувших дней&quot; - детектив 1972 года режиссера Владимира Шределя.<br>
<br>
<br>
      </span></div></td>
    <td width="72" valign="top" bgcolor="#FFFFFF"> 
