...
<html>
<head>
<title>Ж. Ипсиланти, неизв. автор - Вернись (Вернись ко мне и будь опять моей..., с нотами)</title>
<meta name="Description" content="Текст и ноты танго с мольбой к любимой вернуться">
<meta name="Keywords" content="Петр Лещенко, Жорж Ипсиланти"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  <tr> 
	...
	<br><span class="text">
	<span class="header"><strong>ВЕРНИСЬ </strong><br></span>
  <br>
  Музыка Жоржа Ипсиланти<br>
  Слова неизвестного автора<br>
  <br>
  Вернись ко мне и будь опять моей.<br>
  Еще хоть раз хочу назвать своей.<br>
  Любить по прежнему хочу,<br>
  В забвенье ласки всё тебе прощу.<br>
  <br>
  Ну, будь моей, меня не покидай,<br>
  Хоть на минутку сердце мне отдай.<br>
  Ты мне поверь – я так люблю,<br>
  Из-за тебя себя я погублю.<br>
  <br>
  <em>Музыка – не позднее 1934.</em><br>
  <br>
  <br>
  <img src="vernis.gif" width="720" height="1289"><br>
  <br>
 ...
 <br>
  <br>
  Танго из  репертуара Петра Лещенко. Композитор Жорж (Георгий) Ипсиланти руководил оркестром 
  Лещенко. Запись на пластинку - фирма &quot;Bellaccord Electro&quot;, 
  Рига, 1934. Прослушать запись можно <a href="http://www.russian-records.com/details.php?image_id=18703" target="_blank">здесь</a>. <br>
  <br>
  <img src="vernis.jpg" width="579" height="600"><br>
  <br>
  <br>
