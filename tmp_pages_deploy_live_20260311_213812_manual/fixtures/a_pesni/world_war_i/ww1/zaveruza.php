...
<html>
<head>
<title>Сл. и муз. А. Муравьева - За веру, за Царя, за мать Святую Русь</title>
<meta name="Description" content="Текст песни первой мировой с призывом умереть за веру и царя">
<meta name="Keywords" content="Муравьев, Первая мировая война"> 
...
<input name="hl" value="ru" type="hidden"/> 
  ...
  ВЕРУ, ЗА ЦАРЯ, <br>
  ЗА МАТЬ СВЯТУЮ РУСЬ </strong><br></span>
  <em>Песня русского солдата</em><br>
  <br>
  Слова и музыка А. Муравьева<br>
  <br>
  За веру, за Царя, <br>
  За мать Святую Русь <br>
  Без страха и с отвагой <br>
  Я со врагом сражусь. <br>
  <br>
  Пусть дерзкий враг узнает, <br>
  Как, родину любя, <br>
  Солдат наш умирает <br>
  За веру, за Царя. <br>
  <br>
  С достоинством встречает <br>
  Он смерть лицом к лицу, <br>
  Врагов он забывает, <br>
  Молясь о них Творцу. <br>
  <br>
  Народ любя душою, <br>
  Царь ласково сказал: <br>
  "В единстве будь со мною!" <br>
  Народ "Ура!" вскричал!<br>
  <br>
  Да! трусость презирая, <br>
  А доблесть лишь хваля, <br>
  Солдат на поле брани <br>
  Молился за Царя! <br>
  <br>
  Господь, услышь молитву <br>
  Солдата в том бою, <br>
  Пошли Царю победу, <br>
  Я об одном молю. <br>
  <br>
 ...
 <br>
  <br>
  Написано во время Первой мировой войны 1914-1918 гг., - очевидно, до падения монархии в 
  феврале 1917 года. <br>
  <br>
  <br>
