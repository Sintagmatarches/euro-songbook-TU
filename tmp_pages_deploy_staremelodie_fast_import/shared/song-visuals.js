import { normalizeSongPeriod } from "./song-catalogs.js";

export const USSR_PERIOD_YEAR_RANGES = {
  ussr_1922_1940: { from: 1922, to: 1940 },
  ussr_1941_1945: { from: 1941, to: 1945 },
  ussr_1946_1953: { from: 1946, to: 1953 },
  ussr_1953_1964: { from: 1953, to: 1964 },
  ussr_1964_1985: { from: 1964, to: 1985 },
  ussr_1985_1991: { from: 1985, to: 1991 },
};
  ...
  if (year) {
    ...
    if (matched) {
      return {
        from: matched.from,
        to: matched.to,
        desktop: normalizeVisualBackground(matched.desktop),
        mobile: normalizeVisualBackground(matched.mobile),
        symbol: normalizeVisualSymbol(matched.symbol),
      };
    }
  }
  return {
...
export function buildVisualProfileFromLegacyFields(row = {}) {
  ...
  Object.entries(USSR_PERIOD_YEAR_RANGES).forEach(([periodKey, years]) => {
